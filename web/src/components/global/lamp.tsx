...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[800px] flex-col items-center justify-center overflow-hidden bg-[#020817] w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-[#020817] blur-2xl"></div>
